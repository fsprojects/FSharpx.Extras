module FSharpx.Collections.Experimental.Tests.RealTimeDequeTest

open System
open FSharpx.Collections.Experimental
open FSharpx.Collections.Experimental.RealTimeDeque
...
let ``head, tail, and length work test 1``() =
    ...
    && (ht1 = "a") && (ht1C = "a") && (ht1s = "a") && (ht1Cs = "a")) |> should equal true
...
let ``last, init, and length work test 2``() =
    ...
    let lt1C = (last t1C)
    let lt1_1 = (last t1_1)
    let lt1C_1 = (last t1C_1)
    
    (((length t1) = 2) && ((length t1C) = 2) && (lt1 = "b") && (lt1C = "b") && ((length t1_1) = 1) 
    && ((length t1C_1) = 1) && (lt1_1 = "c") 
    && (lt1C_1 = "c")) |> should equal true
