module FSharpx.DataStructures.Tests.AltBinaryRandomAccessListTest

open System
open FSharpx.DataStructures
open FSharpx.DataStructures.AltBinaryRandomAccessList
...
let ``IRandomAccessList cons works``() =
    ((lena :> IRandomAccessList<string>).Cons "zz") :?> AltBinRndAccList<string> |> head |> should equal "zz"