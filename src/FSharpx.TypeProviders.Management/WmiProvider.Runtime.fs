...
type RuntimeAPI() = 
    ...
    static member InvokeStaticManagementMethod(wmiClassPath:string, methName:string, inParamNames:string[], inParamVals:obj[]) =
        use wmiClass = new ManagementClass(wmiClassPath)
