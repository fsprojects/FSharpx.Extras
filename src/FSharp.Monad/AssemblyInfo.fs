...
[<assembly: AssemblyTitle ("A monad library for F# projects.")>]

[<assembly: AssemblyDescription ("A monad library for F# projects, including Maybe, State, Reader, Writer, Continuation, and MinLinq.")>]

[<assembly: AssemblyProduct ("A monad library for F# projects.")>]
