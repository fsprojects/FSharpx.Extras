...
module Vector = 
    ...
    let inline tryInitial (vector :'T Vector) = vector.TryInitial

    let inline isEmpty (vector :'T Vector) = vector.IsEmpty

    let inline last (vector :'T Vector) = vector.Last

    let inline tryLast (vector :'T Vector) = vector.TryLast

    let inline length (vector :'T Vector) : int = vector.Length
